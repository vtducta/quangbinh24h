 ...
 * @copyright  Copyright (c) 2006 - 2011 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
 Loader::load(PATH_EXPORT_FONT);
 Loader::load(PATH_EXPORT_COLOR);
 Loader::load(PATH_EXPORT_FILL);
 Loader::load(PATH_EXPORT_BORDERS);
 Loader::load(PATH_EXPORT_ALIGNMENT);
 Loader::load(PATH_EXPORT_NUMBERFORMAT);
 Loader::load(PATH_EXPORT_STYLE_PROTECTION);
