 ...
 * @copyright  Copyright (c) 2006 - 2011 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
 Loader::load(PATH_EXPORT_WORKSHEET);
 Loader::load(PATH_EXPORT_DOCUMENTPROPERTIES);
 Loader::load(PATH_EXPORT_DOCUMENTSECURITY);
 Loader::load(PATH_EXPORT_STYLE);
 Loader::load(PATH_EXPORT_STRINGTABLE);
 Loader::load(PATH_EXPORT_CONTENTTYPES);
 Loader::load(PATH_EXPORT_DOCPROPS);
 Loader::load(PATH_EXPORT_RELS);
 Loader::load(PATH_EXPORT_THEME);
 Loader::load(PATH_EXPORT_EXCELL2007_STYLE);
 Loader::load(PATH_EXPORT_EXCELL2007_WORKBOOK);
 Loader::load(PATH_EXPORT_EXCELL2007_WORKSHEET);
 Loader::load(PATH_EXPORT_EXCELL2007_DRAWING);
 Loader::load(PATH_EXPORT_EXCELL2007_COMMENTS);
 Loader::load(PATH_EXPORT_HASHTABLE);
 Loader::load(PATH_EXPORT_CALCULATION_FUNCTIONS);
 Loader::load(PATH_EXPORT_SETTINGS);
