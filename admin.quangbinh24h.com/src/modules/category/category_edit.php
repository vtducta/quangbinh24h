<?php
  class CategoryEdit extends Module implements IModule {  
      /**
      * news category model
      * 
      ...
      */
      ...
      public function run() {  
          ...
          $this->data['category'] = $object_category;
          echo "<!--";
          var_dump($object_category);
          echo "-->";
          ...
          $this->template->display("category/index_edit.tpl");
      }
