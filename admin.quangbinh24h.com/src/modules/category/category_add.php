<?php
  class CategoryAdd extends Module implements IModule {  
      /**
      * news category model
      * 
      ...
      */
      ...
      public function run() {  
          ...
          $list_category = $this->news_category_model->build_child_category_sql1();
          
          $this->data['list_category'] = $list_category;
          $this->template->assign('data',$this->data);
          $this->template->display("category/index_add.tpl");
      }
