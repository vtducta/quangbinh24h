<?php
    class BtvNewsPublicAll extends Module implements IModule {  
    /**
    ...
    */
    ...
    public function run() {                      
        ...
        if(!$this->premission_model->check_permission($user_id,5))
        {
            die('no permission');
        }   
        
        $check_user =  array('9596','9597','9598','9600','9602','9609','9608','9704','9720','9603','9604','9607','9610','9617','9630','9638','9658','9660','9671');
        if(in_array($user_id,$check_user)){
            $this->data["allow_xuat_ban"] = '1';
        }else{
            $this->data["allow_xuat_ban"] = '0'; 
        }
        ...
        //}else{
            //$total= $this->news_articles_view_model->get_total_by_mysql("a.status=3 AND a.public=1 AND a.timer=0","",0,"");           
        //}
        ...
        if($content_type)
        {
            $list_news = $this->news_articles_view_model->admin_get_news_by_mysql("status=3 AND public=1  AND hotnews ={$content_type} AND timer=0","create_date_int DESC,id DESC",$offset,$limit);              
        }else{
        ...
        {   
            ...
            $this->template->display("BTV/index.tpl");            
        }
