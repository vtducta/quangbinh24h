<?php
  class ResetPass extends Module implements IModule {  
/**
      * tm users model
      * 
      * @var TmUsersModel
      */
      ...
      public function run() {  
          ...
          $id = intval($id);
          $content = $this->tm_users_model->get_once("user_id ={$id}");
          if(!$content)
          {
            Application::redirect($this->linkHelper->linkhome("ListUser"));
          }
          $this->data['user_info'] = $content;
          $this->template->assign('data',$this->data);
          $this->template->display("user/index_resetpass.tpl");
      }
