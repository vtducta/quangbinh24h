function list_new(page)
{
    ...
    $.ajax({        
        ...
        url : "/",
        dataType : 'html',
        data : {act:"ListNews",id : category_id, page: page},
    ...
    $( ".droppable" ).droppable({
        ...
        drop: function( event, ui ) {
            ...
            $.ajax({
                ...
                success : function(html){                    
                    smoke.confirm('Bạn có muốn muốn hiển thị tin vào vị trí này ?',function(e){
                        if (e){     
                            obj_view.html(html); 
                            $.ajax({                                    
                                type : "GET",
