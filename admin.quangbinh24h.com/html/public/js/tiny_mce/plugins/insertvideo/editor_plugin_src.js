	...
	tinymce.create('tinymce.plugins.insertvideoPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceinsertvideo', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 900 + parseInt(ed.getLang('insertvideo.delta_width', 0)),
					height : 400 + parseInt(ed.getLang('insertvideo.delta_height', 0)),
					inline : 1
				}, {
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('insertvideo', n.nodeName == 'IMG');
			});
		},
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/TinyMCE:Plugins/insertvideo',
				version : "1.0"
			};
		}
	});
