		...
		moveStates : function(to_form, field) {
			...
			if (to_form) {
				...
				if (src.match(/youtube\.com\/embed\/\w+/)) {
					...
					data.type = 'iframe';					
                    setVal('src', src+'?feature=oembed&autoplay=1&wmode=opaque&rel=0&showinfo=0&modestbranding=1&version=3&ps=docs&nologo=1&theme=light&color=white&iv_load_policy=0&cc_load_policy=1');
					setVal('media_type', data.type);
				} else {
					// YouTube *NEW*
