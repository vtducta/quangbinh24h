...
function seo_config() {
    var ele = document.getElementById("seoConfigText");
    var text = document.getElementById("seoDisplayConfig");
...
$(document).ready(function() {
    ...
    $('.quick_post_edit').click(function() {
        var id = $(this).attr('id');
        $('#com_content_' + id).hide();
        $('#quickForm_' + id).show();
     });
     $('.close_quick').click(function() {
        var id = $(this).attr('id');
        $('#com_content_' + id).css({'display':'table-row'});
        $('#quickForm_' + id).hide();
        return false;
     });
});
...
//Set cookie
function setCookieDisplayType(type_name,redirect){
    document.cookie = type_name +"=" +escape(redirect);
    window.location.reload( true );
}

//Distroy cookie
function distroyCookie(type_name,redirect) {
    var dt = new Date();
    expiryTime = dt.setTime(dt.getTime());
    document.cookie = type_name +"=" +escape(redirect)+";expires=" + dt.toGMTString();
}