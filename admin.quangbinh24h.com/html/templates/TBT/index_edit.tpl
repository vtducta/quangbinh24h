                    ...
                    <div class="span8" style="margin:0;">
                        <div class="box">   
                            ...
                            <div class="content clearfix">                                    
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span8">
                                                        ...
                                                        <input type="text" id='meta_title' name="meta_title" value="{if $data.content->get('meta_title')}{$data.content->get('meta_title')}{else}{$data.content->get('title')}{/if}"/>                                                           
                                                    </div> 
                                                </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span8">
                                                        ...
                                                        <textarea class="text" id="meta_description" name="meta_description" style="height:60px; width:100%">{$data.content->get('meta_description')}</textarea>                                                           
                                                    </div> 
                                                </div>
                                            </div> 
                                        </div>
                                    ...
                                    <div class="span12">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8">
                                                ...
                                                <textarea name="short_desc" id="short_desc">{$data.content->get('intro_text')}</textarea>                                                    
                                            </div>
                                        </div>
                                    </div>                                       
                                </div>                                       
                                ...
                                <hr class="line" />
                                <div id="display-file">                                    
                                    <img {if $data.link_thumb} src="{$data.link_thumb->get('upload_url')}" {else} src="" {/if}alt="" style="width: 85px; height: 85px;">
                                </div>                                                                            
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8">                                              
                                                <select name="writter" style="width:250px">
                                                    ...
                                                    <option value="{$val->user_id}" {if $data.content->get('creat_by')==$val->user_id}selected="selected"{/if}> {$val->fullname} - {$val->username}</option>  
                                                    {/foreach}      
                                                </select> 
                                                <br>   
                                ...
                                {if $data.msg_array}
                                <div class="form-row row-fluid">
                                    {foreach $data.msg_array as $msg1}
                                    <p>{$msg1}</p>
                                    {/foreach}
                                </div>
                                {/if}
                                ...
                                <div class="form-row row-fluid">                                                                                
                                    ...
                                    <div class="well">
                                        <div id="datetimepicker1" class="input-append date">
                                            <input data-format="dd-MM-yyyy hh:mm:ss" name="timer" value="{if $data.content->get('timer')}{$data.content->get('timer')|date_format:"%d-%m-%Y %H:%M:%S"}{/if}" type="text" readonly="readonly"></input>
                                            <span class="add-on">
                            ...
                            <div class="content">                                     
                                <div class="form-row row-fluid">
                                    ...
                                    <script type="text/javascript">                        
                                        ...
                                        tokenDelimiter: ",",
                                        preventDuplicates: true,  
                                        prePopulate: {/literal}{$data.list_event_selected}{literal} 
...
{literal}
<script type="text/javascript" {/literal}src="{$GUrl.Js}jquery_submit.js?123" {literal}> </script>
<script type="text/javascript">                        
    $(document).ready(function() {
