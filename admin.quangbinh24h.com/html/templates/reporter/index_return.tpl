            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                {$template_helper->displayAlert()}                    
                    ...
                    <div class="box gradient">                                
                                <div class="title">
                                    <h4>
                                        <span>Danh sách bài trả về</span>
                                    </h4>
                                </div>                
                                             ...
                                             <tr {if $smarty.foreach.foo.index %2!=0} class="second" {/if} >
                                                ...
                                                <td class="alignleft"><span class="lastedit-pe"></span><strong>{$val.title}</strong>
                                                    ...
                                                    <div class="quk-edit">                                                          
                                                        ...
                                                        |                                                               
                                                        <a href="{$link_helper->link_deleted("deletednews",$val.id)}">Xóa bài viết</a>                                                                    
                                                    </div>
                                                </td>                                                
                                                <td>{$val.category}</td>
                                                ...
                                                <td>{$val.tags}</td>
                                                <td><strong style="color: red;">{$val.reason}</strong></td>
                                                <td>
                                ...
                                <div class="margin10 clearfix">    
                                  {if $data.paging.total >1}
                                    <div class="pagination right">
                                          <ul>
                                            <li><a href="{$link_helper->link_admin("ReporterOff",1)}"><span class="icon12 minia-icon-arrow-left-3"></span></a></li>
                                            {foreach from=$data.paging.page item=val key=k} 
                                                <li {if $val eq $data.paging.current} class="active"{/if}>
                                                    <a href="{$link_helper->link_admin("ReporterOff",$val)}"><span>{$val}</span></a>
                                                </li>                                                    
                                            {/foreach}                                               
                                            <li><a href="{$link_helper->link_admin("ReporterOff",$data.paging.total)}"> <span class="icon12 minia-icon-arrow-right-3"></span></a></li>
                                          </ul>
                                    </div>                                        
                                    {/if}                           
                                </div>
