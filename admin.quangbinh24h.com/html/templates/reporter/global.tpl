<div class="centerContent">                                 
    <ul class="bigBtnIcon">                                
        <li>
            <a href="{$link_helper->linkhome('ReporterAdd')}">
        ...
        <li>
            <a href="{$link_helper->linkhome('HomeReporter')}" title="Bài đã được đăng" class="pattern tipB">
        ...
        <li>
            <a href="{$link_helper->linkhome('ReporterWait')}" title="Bài Chờ duyệt" class="pattern tipB">
