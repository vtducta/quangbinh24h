                    ...
                    <div class="span8" style="margin:0;">
                        <div class="box">   
                            ...
                            <div class="content clearfix">                                    
                                <div class="form-row row-fluid">
                                    <div class="span12">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8">
                                                <input class="" id="id_title" type="text" name="title" value="{$data.object_video->get('title')}" />                                                                                                        
                                            </div>
                                        </div>
                                    </div>
                                </div>                                                                         
                                ...
                                <div id="display-file">
                                    {if $data.link_thumb >0}
                                    <img src="{$data.link_thumb->get('upload_url')|replace:'mediabaouc.netlink.vn':'media danang24h.tinmoi.vn'}" alt="" style="width: 85px; height: 85px;">
                                    {else}
                                    <img src="/images/noimg.gif" alt="" style="width: 85px; height: 85px;">
                                    {/if}
                                </div>
                                <input type="hidden" id="flagthumb" name="id_thumb" value="{$data.object_video->get('images')}"> 
                                <hr class="line" />   
                                
                                <div style="float: left;margin: 5px;">
                                    <button id="uploadfile" type="button" ><span>Tải file từ máy tính</span></button>
                                    <div id="display-file-doc"  style="width: 85px;height: 85px;" >{$data.object_video->get('link')}</div>
                                </div>
                                <p><span id="statusfile"></span></p>
                                <label class="error" style="display:none;">Báo lỗi</label>
                                <input type="hidden" id="link" name="link" value="{$data.object_video->get('link')}">
                                <hr class="line" />
    
                                <input type="hidden" name="id" readonly="readonly"  value="{$data.object_video->get('id')}" />
                                <input type="hidden" name="action" value="editvideo" />
                                <input type="hidden" name="act" value="VideoActionHtml5" />                                                    
                                <div class="form-row row-fluid">
                                    <div class="span12">
                                        <div class="row-fluid">
                                            <button class="btn btn-info btn-large" id="addvideo">Sửa video</button>
                                        </div>                                            
                                    </div>  
                                </div>                                      
                            </div><!--content-->
