                        ...
                        <div class="box">   
                            ...
                            <div class="content clearfix">                                    
                                ...
                                <div class="form-row row-fluid">
                                    <div class="span12">
                                        <div class="row-fluid">                                                                                                                                        
                                            <button class="btn btn-info btn-large" id="sendnews">Gửi bài</button>
                                            {if $data.action=="newswait"}
                                            <button class="btn btn-info btn-large" id="btv_save_news">Update</button>
                                            <button class="btn btn-danger btn-large" id="btv_return">Trả bài</button>
                                            {else}
                                            <button class="btn btn-danger btn-large" id="btv_draft">Lưu tạm</button>
                                            {/if}
                                        </div>
                                    </div>  
                                </div>
                    ...
                    <div class="span4">
                        <div class="box">
                            ...
                            <div class="content" style="max-height:300px;overflow-y:scroll">
                                ...
                                {if in_array($val.id,$data.list_cat_user)}
                                ...
                                {if in_array($item.id,$data.list_cat_user)}  
...
{literal}
<script type="text/javascript" {/literal}src="{$GUrl.Js}jquery_submit.js?134" {literal}> </script>
{/literal}  
