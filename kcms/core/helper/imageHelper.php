<?php
class imageHelper extends Helper implements IImage
{
    /**
    * file permisssion
    */
    ...
    * @var        array
    */
    private $orig_dimensions    = array( 'width' => 0, 'height' => 0 );
    ...
    * @var        array
    */
    private $image_types        = array( 'gif', 'jpeg', 'jpg', 'jpe', 'png' );
    ...
    */
    public function writeImage( $imagePath )
    {
        ...
        if( is_file( $imagePath ) )
        {
            ...
            if (!@is_dir($imageDir)){
                if(!@mkdir($imageDir,imageHelper::FOLDER_PERMISSION,true)){
                    die("Check config server, mkdir could not create dir" . $imageDir);
                }
            }
        }
        ...
        @chmod( $imagePath, imageHelper::FILE_PERMISSION );
    ...
    * @return     @e string
    */
    private function _cleanPaths( $path='' )
    {
        //---------------------------------------------------------
    ...
    */
     ...
     * @return    @e array
     */
    private function _getResizeDimensions( $width, $height )
    {
         //---------------------------------------------------------
     ...
     * @return    @e array
     */
    private function _scaleImage( $arg )
    {
        $ret = array(
    ...
    {
        $fileExt = $this->_getFileExtension( $imagePath );
