...
class Configuration
{
  ...
  */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Configuration::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  public static function YAMLLoad($input) {
    ...
    return $Configuration->load($input);
  }
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Configuration::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  public static function YAMLLoadString($input) {
    $Configuration = new Configuration;
    return $Configuration->loadString($input);
  }
...
/* LOADING FUNCTIONS */
  ...
  private function addArray ($array, $indent) {
    ...
    $tempPath = Configuration::flatten ($this->path);
    ...
    if ($this->_containsGroupAlias) {
      do {
        ...
        eval ('$value = $this->result' . Configuration::flatten ($groupPath) . ';');
      } while (false);
